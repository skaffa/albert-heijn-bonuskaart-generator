...
> So far this has happened 5 times to me, paying about 40 cents extra each, and once even for Airmiles.  
...
Update: Even in the store it has worked every single time so far (about 70 times)
